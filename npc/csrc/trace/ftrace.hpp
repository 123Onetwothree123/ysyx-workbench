...
extern Ftrace GlobalFtrace;                                                                                               // 全局ftrace状态
[[nodiscard]] std::expected<void, std::string> InitializeFtrace(const std::filesystem::path &ElfFile, bool ShouldEnable); // 初始化全局ftrace并按参数设置开关
