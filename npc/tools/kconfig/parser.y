...
end:	  T_ENDMENU T_EOL	{ $$ = const_cast<char*>("menu"); }
	| T_ENDCHOICE T_EOL	{ $$ = const_cast<char*>("choice"); }
	| T_ENDIF T_EOL		{ $$ = const_cast<char*>("if"); }
;
...
void conf_parse(const char *name)
{
	...
	if (!menu_has_prompt(&rootmenu)) {
		...
		menu_add_prompt(P_MENU, const_cast<char*>("Main menu"), NULL);
	}
