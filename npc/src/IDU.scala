...
class IDU extends Module {
  ...
  // 控制WBU的，不知道该不该让IDU来控制WBU，本来想手搓一个控制模块的，结果模块多了，还分不清
  val WB_ALU = 0.U(2.W)
