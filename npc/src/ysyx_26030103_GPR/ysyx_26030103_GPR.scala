...
class ysyx_26030103_GPR extends Module {
  ...
  val ysyx_26030103_RegisterFile = Module(new ysyx_26030103_RegisterFile(ADDR_WIDTH = 5, DATA_WIDTH = 32))
  ...
  io.ReadDATA1 := Mux(io.Read1SELECT === 0.U, 0.U(32.W), ysyx_26030103_RegisterFile.io.rdata1)
  io.ReadDATA2 := Mux(io.Read2SELECT === 0.U, 0.U(32.W), ysyx_26030103_RegisterFile.io.rdata2)
