...
module riscv32e_npc_SimTop(
  ...
  output        debug_commit,
  output        debug_trap_valid,
  output [31:0] debug_trap_pc,
  output [31:0] debug_trap_target,
  output [31:0] debug_trap_cause,
  output [31:0] debug_csr_mstatus,
  output [31:0] debug_csr_mtvec,
  output [31:0] debug_csr_mepc,
  output [31:0] debug_csr_mcause,
  output [31:0] debug_trap_mstatus,
  output [31:0] debug_trap_mtvec,
  output [31:0] debug_trap_mepc,
  output [31:0] debug_trap_mcause,
  ...
  output perf_mdu_req, perf_mdu_done, perf_mdu_active, perf_mdu_wait,
  output [2:0] perf_mdu_op, perf_exu_event_kind,
  ...
  ysyx_26030103 cpu (
    ...
    .io_debug_pc(debug_pc), .io_debug_next_pc(debug_next_pc),
    .io_debug_arch_pc(debug_arch_pc),
    .io_debug_instructions(debug_instructions),
    ...
    .io_debug_trap_valid(debug_trap_valid),
    .io_debug_trap_pc(debug_trap_pc),
    .io_debug_trap_target(debug_trap_target),
    .io_debug_trap_cause(debug_trap_cause),
    .io_debug_csr_mstatus(debug_csr_mstatus),
    .io_debug_csr_mtvec(debug_csr_mtvec),
    .io_debug_csr_mepc(debug_csr_mepc),
    .io_debug_csr_mcause(debug_csr_mcause),
    .io_debug_trap_mstatus(debug_trap_mstatus),
    .io_debug_trap_mtvec(debug_trap_mtvec),
    .io_debug_trap_mepc(debug_trap_mepc),
    .io_debug_trap_mcause(debug_trap_mcause),
    ...
    .io_perf_mdu_req(perf_mdu_req), .io_perf_mdu_done(perf_mdu_done),
    .io_perf_mdu_op(perf_mdu_op), .io_perf_mdu_active(perf_mdu_active),
    .io_perf_mdu_wait(perf_mdu_wait),
    .io_perf_exu_event_kind(perf_exu_event_kind),
